...
```{r read df}
rides_all <- read.csv("rides_2022.csv")
head(rides_all)
```
...
## Recommendation 1: Casual riders use the same few stations
Let's start with a basic version of a circular representation of the data
```{r, warning=FALSE, fig.align='center' }

```

## Recommendation 2: Casual riders ride more often on weekends and during summer
```{r, warning=FALSE, fig.align='center' }

```

## Recommendation 3: Casual riders use bikes more often on off-peak times
```{r, warning=FALSE, fig.align='center' }
